...
describe("post /chats", () => {
    ...
    test("Test post chat", async () => {
        ...
        const response = await request(app)
            ...
            .field('eventId', event1_Id.toString())
            .field('message', "halo ges")
            .attach('image', imageBuffer, 'images.jpeg');
        expect(response.status).toBe(200)
        expect(response.body).toBeInstanceOf(Object)
        expect(response.body).toHaveProperty('eventId', expect.any(String))
